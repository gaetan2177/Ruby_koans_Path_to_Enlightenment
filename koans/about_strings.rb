...
It was the worst of times.
    ...
    assert_equal "\n", long_string[0,1]  #needs reviewing, confusing
  end
...
EOS
    ...
    assert_equal "I", long_string[0,1]   # a small review to arrays and slicing
  end
  ...
  def test_single_quoted_strings_do_not_interpolate
    value = 123
    string = 'The value is #{value}'
    assert_equal "The value is \#{value}", string  #No Idea why we added a backslash in front of the hash
  end
