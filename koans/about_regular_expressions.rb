...
class AboutRegularExpressions < Neo::Koan
  ...
  def test_the_left_most_match_wins
    assert_equal "az", "bbbccc az"[/az*/]   #removed the first "a" and put a "b" instead. now searches for the next "az"
  ...
  def test_slash_d_is_a_shortcut_for_a_digit_character_class
    assert_equal  "44", "the number is 44"[/[0123456789]+/] #needs research
  ...
  def test_slash_b_anchors_to_a_word_boundary
    assert_equal "vines", "bovine vines"[/\bvine./] #research 
  end
  ...
  def test_sub_is_like_find_and_replace
    assert_equal "o two-three", "one two-three".sub(/(o\w*)/) { $1[0, 1] }
  end
